...
G, neighbor, nests, node_num = graph_generator(N_node=node_number, n_nests=n_nests,connectivity=connectivity)
...
# fig.add_trace(go.Scatter(x=sp_Xe,
#          y=sp_Ye,
#          mode = "lines",
...
for i in range(T):
    ...
    # frame["data"].append(go.Scatter(x=sp_Xe,
    #      y=sp_Ye,
    #      mode = "lines",
    #      line = dict(color='red', width=3),
    #      hoverinfo = 'none'))
